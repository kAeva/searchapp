...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <img alt="product picture" src="img/placeholder.png" width="300px" height="300px" style="margin: 0 auto; display: block;">
            </div>

            <div class="col mt-3">
                <h6><b>Available:</b> <%=product.getQuant()%></h6>
                <h6><b>Price:</b> <%=product.getPrice()%></h6>
                <h6><b>Category:</b> <%=product.getCategory()%></h6>
                <h6>Description</h6>
                <p><%=product.getDescription()%></p>
                <h6><b>Location (section number):</b> <%=product.getSectionNum()%></h6>
