...
<div class="container">
    <div class="map" style="display: block;background-image: url('/images/store-layout.png');
background-size: contain;position: relative;padding: 0px; width: 1008px;height: 612px;">
...
padding: 0px; border: 0px; opacity: 1;" height="593" width="960">
        ...
        <img class="map maphilighted" alt="store-layout" src="/images/store-layout.png" usemap="#mappy" style="opacity: 0.2;
